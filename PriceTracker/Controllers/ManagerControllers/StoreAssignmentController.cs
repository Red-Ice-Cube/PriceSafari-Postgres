...
namespace PriceTracker.Controllers
{
    ...
    public class StoreAssignmentController : Controller
    {
        ...
        public StoreAssignmentController(UserManager<PriceTrackerUser> userManager, RoleManager<IdentityRole> roleManager, PriceTrackerContext context, ILogger<StoreAssignmentController> logger)
        {
        ...
        public async Task<IActionResult> AssignStores(string SelectedUserId, List<int> SelectedStoreIds)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                foreach (var storeId in SelectedStoreIds)
                {
                    ...
                    {
                        _context.UserStores.Add(new PriceTrackerUserStore { UserId = SelectedUserId, StoreId = storeId });
                    }
                }
