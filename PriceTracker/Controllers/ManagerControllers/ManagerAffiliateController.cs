...
namespace PriceTracker.Controllers.ManagerControllers
{
...

    {
        ...
        public ManagerAffiliateController(UserManager<PriceTrackerUser> userManager, PriceTrackerContext context, IEmailSender emailSender)
        {
        ...
        public async Task<IActionResult> Accounts()
        {
            ...
            var filteredUsers = new List<PriceTrackerUser>();
