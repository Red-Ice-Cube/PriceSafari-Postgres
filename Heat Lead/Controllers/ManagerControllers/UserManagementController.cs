...
namespace Heat_Lead.Controllers
{
    ...
    public class UserManagementController : Controller
    {
        ...
        public UserManagementController(UserManager<Heat_LeadUser> userManager, RoleManager<IdentityRole> roleManager, IEmailSender sender, Heat_LeadContext context)
        {
