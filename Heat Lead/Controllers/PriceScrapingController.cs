...
public class PriceScrapingController : Controller
{
    ...
    public PriceScrapingController(Heat_LeadContext context, Scraper scraper, IHubContext<ScrapingHub> hubContext, IServiceProvider serviceProvider)
    {
        _context = context;
        _scraper = scraper;
        ...
        foreach (var product in products)
        {
            tasks.Add(Task.Run(async () =>
            {
                ...
                try
                {
                    ...
                    var scopedContext = scope.ServiceProvider.GetRequiredService<Heat_LeadContext>();
