...
namespace Heat_Lead.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        private readonly IUserStore<Heat_LeadUser> _userStore;
        private readonly IUserEmailStore<Heat_LeadUser> _emailStore;
        ...
        public RegisterModel(
            ...
            IUserStore<Heat_LeadUser> userStore,
        ...
        private Heat_LeadUser CreateUser()
        {
            try
            {
                return Activator.CreateInstance<Heat_LeadUser>();
            }
            catch
            {
                throw new InvalidOperationException($"Can't create an instance of '{nameof(Heat_LeadUser)}'. " +
                    $"Ensure that '{nameof(Heat_LeadUser)}' is not an abstract class and has a parameterless constructor, or alternatively " +
                    $"override the register page in /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }

        private IUserEmailStore<Heat_LeadUser> GetEmailStore()
        {
            if (!_userManager.SupportsUserEmail)
            {
                throw new NotSupportedException("The default UI requires a user store with email support.");
            }
            return (IUserEmailStore<Heat_LeadUser>)_userStore;
        }
    }
}
