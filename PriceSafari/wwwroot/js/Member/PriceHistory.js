document.addEventListener("DOMContentLoaded", function () {
    ...
    function renderPrices(data) {
        ...
        data.forEach(item => {
            ...
            priceBoxSpace.appendChild(priceBoxColumnStoreCount);
            ...
            box.appendChild(priceBoxColumnStoreCount);  // Liczba ofert
...
//            // Nowy div dla liczby ofert
//            const priceBoxColumnStoreCount = document.createElement('div');
//            priceBoxColumnStoreCount.className = 'price-box-column-offers';
//            priceBoxColumnStoreCount.innerHTML = 'Liczba ofert: ' + item.storeCount;

//            // Dodajemy kategorię i liczbę ofert do priceBoxSpace
//            priceBoxSpace.appendChild(priceBoxColumnCategory);
//            priceBoxSpace.appendChild(priceBoxColumnStoreCount);
...
//            if (!isRejected) {
//                if (item.colorClass === "prToHigh") {
//                    // Kod dla prToHigh (trzy opcje)
//                    const diffClass = item.colorClass + ' ' + 'priceBox-diff';

//                    if (myPrice != null && item.lowestPrice != null && setPrice1 != null && setPrice2 != null) {
//                        // Upewnij się, że wartości są liczbami
//                        const myPriceValue = parseFloat(myPrice);
//                        const lowestPriceValue = parseFloat(item.lowestPrice);
//                        const setPrice1Value = parseFloat(setPrice1);
//                        const setPrice2Value = parseFloat(setPrice2);

//                        if (isNaN(myPriceValue) || isNaN(lowestPriceValue) || isNaN(setPrice1Value) || isNaN(setPrice2Value)) {
//                            priceBoxColumnInfo.innerHTML += '<div class="' + diffClass + '">Obniż: N/A</div>';
//                        } else {
//                            // Obliczenia dla ceny suboptymalnej
//                            let priceReductionSubOptimal = setPrice2Value;
//                            let newPriceSubOptimal = myPriceValue - priceReductionSubOptimal;

//                            if (newPriceSubOptimal < lowestPriceValue) {
//                                newPriceSubOptimal = lowestPriceValue;
//                                priceReductionSubOptimal = myPriceValue - newPriceSubOptimal;
//                            }

//                            if (newPriceSubOptimal < 0) {
//                                newPriceSubOptimal = 0;
//                                priceReductionSubOptimal = myPriceValue;
//                            }

//                            const percentageReductionSubOptimal = (priceReductionSubOptimal / myPriceValue) * 100;

//                            // Obliczenia dla ceny konkurencyjnej
//                            let priceReductionCompetitive = myPriceValue - lowestPriceValue;
//                            let newPriceCompetitive = lowestPriceValue;

//                            if (newPriceCompetitive < 0) {
//                                newPriceCompetitive = 0;
//                                priceReductionCompetitive = myPriceValue;
//                            }

//                            const percentageReductionCompetitive = (priceReductionCompetitive / myPriceValue) * 100;

//                            // Obliczenia dla ceny strategicznej
//                            let priceReductionStrategic = setPrice1Value;
//                            let newPriceStrategic = myPriceValue - priceReductionStrategic;

//                            if (newPriceStrategic < 0) {
//                                newPriceStrategic = 0;
//                                priceReductionStrategic = myPriceValue;
//                            }

//                            const percentageReductionStrategic = (priceReductionStrategic / myPriceValue) * 100;

//                            // Formatuj wartości
//                            const priceReductionSubOptimalFormatted = '-' + priceReductionSubOptimal.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';
//                            const percentageReductionSubOptimalFormatted = '(-' + percentageReductionSubOptimal.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '%)';
//                            const newPriceSubOptimalFormatted = newPriceSubOptimal.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';

//                            const priceReductionCompetitiveFormatted = '-' + priceReductionCompetitive.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';
//                            const percentageReductionCompetitiveFormatted = '(-' + percentageReductionCompetitive.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '%)';
//                            const newPriceCompetitiveFormatted = newPriceCompetitive.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';

//                            const priceReductionStrategicFormatted = '-' + priceReductionStrategic.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';
//                            const percentageReductionStrategicFormatted = '(-' + percentageReductionStrategic.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '%)';
//                            const newPriceStrategicFormatted = newPriceStrategic.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';

//                            // Kolorowe kwadraty
//                            const yellowSquare = '<div style="width:15px; height:15px; background-color:yellow; display:inline-block; margin-right:5px;"></div>';
//                            const greenSquare = '<div style="width:15px; height:15px; background-color:green; display:inline-block; margin-right:5px;"></div>';
//                            const turquoiseSquare = '<div style="width:15px; height:15px; background-color:turquoise; display:inline-block; margin-right:5px;"></div>';

//                            // Dodaj informacje do priceBoxColumnInfo
//                            priceBoxColumnInfo.innerHTML +=
//                                '<div class="' + diffClass + '">' + yellowSquare + 'Obniż o ' + priceReductionSubOptimalFormatted + ' ' + percentageReductionSubOptimalFormatted + ' aby zejść do ceny suboptymalnej (Nowa cena: ' + newPriceSubOptimalFormatted + ')</div>';

//                            priceBoxColumnInfo.innerHTML +=
//                                '<div class="' + diffClass + '">' + greenSquare + 'Obniż o ' + priceReductionCompetitiveFormatted + ' ' + percentageReductionCompetitiveFormatted + ' aby zejść do ceny konkurencyjnej (Nowa cena: ' + newPriceCompetitiveFormatted + ')</div>';

//                            priceBoxColumnInfo.innerHTML +=
//                                '<div class="' + diffClass + '">' + turquoiseSquare + 'Obniż o ' + priceReductionStrategicFormatted + ' ' + percentageReductionStrategicFormatted + ' aby zejść do ceny strategicznej (Nowa cena: ' + newPriceStrategicFormatted + ')</div>';
//                        }
...
//                    // Kod dla prMid (dwie opcje)
//                    const diffClass = item.colorClass + ' ' + 'priceBox-diff';

//                    if (myPrice != null && item.lowestPrice != null && setPrice1 != null) {
//                        const myPriceValue = parseFloat(myPrice);
//                        const lowestPriceValue = parseFloat(item.lowestPrice);
//                        const setPrice1Value = parseFloat(setPrice1);

//                        if (isNaN(myPriceValue) || isNaN(lowestPriceValue) || isNaN(setPrice1Value)) {
//                            priceBoxColumnInfo.innerHTML += '<div class="' + diffClass + '">Obniż: N/A</div>';
//                        } else {
//                            // Obliczenia dla ceny konkurencyjnej (zejście do najniższej ceny)
//                            let priceReductionCompetitive = myPriceValue - lowestPriceValue;
//                            let newPriceCompetitive = lowestPriceValue;
...
//                            // Obliczenia dla przebicia najlepszej ceny o krok (najlepsza cena - setPrice1)
//                            let targetPriceUndercut = lowestPriceValue - setPrice1Value;
//                            if (targetPriceUndercut < 0) {
//                                targetPriceUndercut = 0;
//                            }
//                            let priceReductionUndercut = myPriceValue - targetPriceUndercut;
//                            if (priceReductionUndercut < 0) {
//                                priceReductionUndercut = 0;
//                                targetPriceUndercut = myPriceValue;
//                            }
//                            const percentageReductionUndercut = (priceReductionUndercut / myPriceValue) * 100;
...
//                            const priceReductionUndercutFormatted = '-' + priceReductionUndercut.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';
//                            const percentageReductionUndercutFormatted = '(-' + percentageReductionUndercut.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + '%)';
//                            const newPriceUndercutFormatted = targetPriceUndercut.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN';
...
//                            priceBoxColumnInfo.innerHTML +=
//                                '<div class="' + diffClass + '">' + turquoiseSquare + 'Obniż o ' + priceReductionUndercutFormatted + ' ' + percentageReductionUndercutFormatted + ' aby przebić najlepszą cenę o ' + setPrice1Value.toLocaleString('pl-PL', { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' PLN (Nowa cena: ' + newPriceUndercutFormatted + ')</div>';
//                        }
//                    } else {
//                        priceBoxColumnInfo.innerHTML += '<div class="' + diffClass + '">Obniż: N/A</div>';
//                    }
