document.addEventListener("DOMContentLoaded", function () {
    ...
    //    // Paginacja – zakładamy, że currentPage i itemsPerPage są globalne
    //    const startIndex = (currentPage - 1) * itemsPerPage;
    //    const endIndex = currentPage * itemsPerPage;
    //    const paginatedData = data.slice(startIndex, endIndex);

    //    paginatedData.forEach(item => {
    //        // Sprawdzamy, czy dla tego produktu mamy już zapisaną zmianę ceny w LS
    //        const alreadyAdded = selectedPriceChanges.some(change => change.productId == item.productId);
    ...
    //        // Jeśli zmiana już została dodana, dodajemy klasę na kontenerze
    //        if (alreadyAdded) {
    //            box.classList.add('price-changed');
    //        }
    ...
    //        // Jeśli dostępny jest numer EAN, wyświetlamy go
    //        if (item.externalId) {
    ...
    //        // ★ TOP – ranking ofert konkurencyjnych
    ...
    //            }
    //        }
    //        // Wyświetlenie procentowej różnicy (singleBestCheaperDiffPerc)
    ...
    //                storeNameSpan.style.fontWeight = '500';
    //                storeNameSpan.style.marginRight = '20px';
    //                storeNameSpan.textContent = myStoreName;
    ...
    //                priceChangeContainer.appendChild(storeNameSpan);
    ...
    //        // Funkcja do przypinania przycisku "Zmień cenę" – po kliknięciu wywołuje zdarzenie zmiany ceny
    ...
    //        // W zależności od koloru produktu (typ oferty) budujemy linię symulacji
    //        if (!isRejected) {
    //            // SOLO
    ...
    //                    // Przycisk "Zmień cenę" – tworzymy przycisk i dołączamy listener
    ...
    //                    attachPriceChangeListener(matchPriceBtn, suggestedPrice1);
    //                    // Jeśli zmiana już została dodana, zmieniamy stan przycisku
    //                    if (alreadyAdded) {
    //                        matchPriceBtn.classList.add('active');
    //                        matchPriceBtn.style.backgroundColor = "#333333";
    //                        matchPriceBtn.style.color = "#f5f5f5";
    //                        matchPriceBtn.textContent = "Dodano ";
    //                        // Dołączamy link do usunięcia zmiany
    //                        const removeLink = document.createElement('span');
    //                        removeLink.textContent = " | usuń";
    //                        removeLink.style.textDecoration = "none";
    //                        removeLink.style.cursor = "pointer";
    //                        removeLink.addEventListener('click', function (ev) {
    //                            ev.stopPropagation();
    //                            matchPriceBtn.classList.remove('active');
    //                            matchPriceBtn.style.backgroundColor = "";
    //                            matchPriceBtn.style.color = "";
    //                            matchPriceBtn.textContent = "Zmień cenę";
    //                            const removeEvent = new CustomEvent('priceBoxChangeRemove', {
    ...
    //                            filterPricesAndUpdateUI(false);
    //                        });
    //                        matchPriceBtn.appendChild(removeLink);
    //                    }
    ...
    //                    attachPriceChangeListener(strategicPriceBtn, suggestedPrice2);
    //                    if (alreadyAdded) {
    //                        strategicPriceBtn.classList.add('active');
    //                        strategicPriceBtn.style.backgroundColor = "#333333";
    //                        strategicPriceBtn.style.color = "#f5f5f5";
    //                        strategicPriceBtn.textContent = "Dodano ";
    //                        const removeLink2 = document.createElement('span');
    //                        removeLink2.textContent = " | usuń";
    //                        removeLink2.style.textDecoration = "none";
    //                        removeLink2.style.cursor = "pointer";
    //                        removeLink2.addEventListener('click', function (ev) {
    //                            ev.stopPropagation();
    //                            strategicPriceBtn.classList.remove('active');
    //                            strategicPriceBtn.style.backgroundColor = "";
    //                            strategicPriceBtn.style.color = "";
    //                            strategicPriceBtn.textContent = "Zmień cenę";
    //                            const removeEvent = new CustomEvent('priceBoxChangeRemove', {
    //                                detail: { productId: item.productId }
    //                            });
    ...
    //                            filterPricesAndUpdateUI(false);
    //                        });
    //                        strategicPriceBtn.appendChild(removeLink2);
    //                    }
    ...
    //                        matchPriceBtn.className = 'simulate-change-btn';
    //                        matchPriceBtn.textContent = 'Zmień cenę';
    //                        attachPriceChangeListener(matchPriceBtn, lowestPrice);
    //                        if (alreadyAdded) {
    //                            matchPriceBtn.classList.add('active');
    //                            matchPriceBtn.style.backgroundColor = "#333333";
    //                            matchPriceBtn.style.color = "#f5f5f5";
    ...
    //                        strategicPriceBtn.className = 'simulate-change-btn';
    //                        strategicPriceBtn.textContent = 'Zmień cenę';
    //                        attachPriceChangeListener(strategicPriceBtn, strategicPrice);
    //                        if (alreadyAdded) {
    //                            strategicPriceBtn.classList.add('active');
    //                            strategicPriceBtn.style.backgroundColor = "#333333";
    //                            strategicPriceBtn.style.color = "#f5f5f5";
    ...
    //                                filterPricesAndUpdateUI(false);
    //                            });
    //                            strategicPriceBtn.appendChild(removeLink);
    //                        }
    //                        strategicPriceLine.appendChild(strategicPriceBtn);
    //                        strategicPriceBox.appendChild(strategicPriceLine);
    ...
    //                        const downArrow2 = document.createElement('span');
    //                        downArrow2.className = downArrowClass;
    //                        const reduceText2 = document.createElement('span');
    //                        reduceText2.innerHTML = amount2Formatted + ' ' + percentage2Formatted;
    //                        const newPriceText2 = document.createElement('div');
    //                        newPriceText2.innerHTML = newSuggestedPrice2Formatted;
    //                        const colorSquare2 = document.createElement('span');
    ...
    function renderPrices(data) {
        ...
        // Paginacja – zakładamy, że currentPage i itemsPerPage są zdefiniowane globalnie
        const startIndex = (currentPage - 1) * itemsPerPage;
        const endIndex = currentPage * itemsPerPage;
        const paginatedData = data.slice(startIndex, endIndex);
