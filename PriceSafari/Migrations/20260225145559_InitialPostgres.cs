        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CeneoFeedSubmittedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GoogleFeedSubmittedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    PendingStoreNameAllegro = table.Column<string>(type: "text", nullable: true),
                    AllegroSubmittedOn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ScheduledMeetingDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRunDateOfTask = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllegroTokenExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllegroMarginPriceUpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    AllegroEan = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    OfferUrl = table.Column<string>(type: "text", nullable: true),
                    FoundOnCeneoDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    FoundOnGoogle = table.Column<bool>(type: "boolean", nullable: true),
                    FoundOnGoogleDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    OnGoogle = table.Column<bool>(type: "boolean", nullable: false),
                    Url = table.Column<string>(type: "text", nullable: true),
                    ...
                    MarginPriceUpdatedDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    GoogleXMLPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    GoogleDeliveryXMLPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    CeneoXMLPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    CeneoDeliveryXMLPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
