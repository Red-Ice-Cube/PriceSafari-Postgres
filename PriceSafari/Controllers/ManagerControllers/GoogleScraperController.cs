...
public class GoogleScraperController : Controller
{
        ...
        bool ensureNameMatch = false)
    {
        ...
        // ZMIANA: Nowe rozgałęzienie logiki
        if (ensureNameMatch)
        {
        ...
        {
            // Uruchom logikę "Pierwszy Trafiony"
    ...
    // ##########################################################################################
    // NOWA METODA ZARZĄDZAJĄCA SCRAPOWANIEM W TRYBIE POŚREDNIM
    // ##########################################################################################
